...
\usepackage{tocloft}%for tocaddtitleline
...
\cftaddtitleline{toc}{chapter}{口試委員會審定書}{}
...
\input{introduction}
\input{previousworks}
%\input{theoraticalbg} %theoratical background is merged to propsed method, becasuse it has only one section
\input{proposed}
%\input{svm_hmm}
\input{corpus}
\input{exp}
